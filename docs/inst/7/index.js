...
for (let i = 0; i < 7; ++i) {
	blues.push(xbutton("upper_right_blue", -810 + i * 130, 500));
	blues.push(xbutton("small_blue"   , 20 + i * 130, 260));
	yellows.push(xbutton("upper_right_yellow", -810 + i * 130, 500));
	yellows.push(xbutton("small_yellow"   , 20 + i * 130, 260));
}

const freq      = i => scale(7, 80, i);
